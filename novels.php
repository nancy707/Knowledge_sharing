    ...
    <!-- ################################################################################################ -->
			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      <h2 class="heading">Novels</h2>
			      <p>Writing fiction is the act of weaving a series of lies to arrive at a greater truth.</p>
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='novel' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='novel'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='novel'");
					}
