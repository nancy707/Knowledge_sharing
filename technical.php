    ...
    <!-- ################################################################################################ -->
			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      <h2 class="heading">Technical Books</h2>
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='technical' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='technical'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='technical'");
					}
