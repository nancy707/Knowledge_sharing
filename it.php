			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      <h2 class="heading">Information Technology</h2>
        ...
        <form class="navbar-form navbar-left" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="sem">
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='IT' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='IT'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where dept='IT'");
					}
