    ...
    <!-- ################################################################################################ -->
			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      <h2 class="heading">Lecture Notes</h2>
			      <p>A lecture is much more of a dialogue than many of you probably realize.</p>
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='notes' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='notes'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='notes'");
					}
