    ...
    <!-- ################################################################################################ -->
			...
			<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/stack-of-books.jpg');">
			  ...
			  <div id="pageintro" class="hoc clear">
			    ...
			    <article class="introtxt">
			      ...
			      <p>Writing in a journal reminds you of your goals and of your learning in life.</p>
			    </article>
			    <!-- ################################################################################################ -->
			  </div>
			</div>
          ...
          <?php
					if(isset($_POST['search'])){
						...
						if($sem!=0){
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='journal' and sem=$sem");
					}else{
            $raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='journal'");
				  }}
					else{
						$raw_results = mysqli_query($con,"SELECT * FROM `book_details` where category='journal'");
					}
